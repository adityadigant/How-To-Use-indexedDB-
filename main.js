  ...
  request.onsuccess = function (event) {
    ...
    **/
    ...
    if (request.result) {
      ...
      document.getElementById("employee_id").innerHTML = request.result.office;
      document.getElementById("supervisor").innerHTML = request.result.office;
      document.getElementById("department").innerHTML = request.result.attachment.Department.value;
      document.getElementById("region").innerHTML = request.result.office;
